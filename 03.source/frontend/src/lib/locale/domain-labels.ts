...
export const DOMAIN_VALUE_I18N: Record<string, LocalizableText> = {
  ...
  // ServiceStage (TKST) — 영문 code_value
  open: { ko: "접수", en: "Received" },
  assigned: { ko: "배정", en: "Assigned" },
  dispatched: { ko: "출동", en: "Dispatched" },
  in_progress: { ko: "작업", en: "In progress" },
  closed: { ko: "완료", en: "Completed" },
  // PartOrderStatus (PRST) — 영문 code_value
  requested: { ko: "요청", en: "Requested" },
  confirmed: { ko: "확정", en: "Confirmed" },
  shipped: { ko: "출고", en: "Shipped" },
  in_transit: { ko: "운송중", en: "In transit" },
  delivered: { ko: "도착", en: "Arrived" },
  completed: { ko: "교체완료", en: "Replaced" },
  // InstallationStatus (INST) — 영문 code_value
  planned: { ko: "예정", en: "Planned" },
  commissioning: { ko: "시운전", en: "Commissioning" },
  done: { ko: "완료", en: "Done" },
  // AlgorithmStatus (ALGS)
  active: { ko: "활성", en: "Active" },
  inactive: { ko: "비활성", en: "Inactive" },
  staging: { ko: "스테이징", en: "Staging" },
  disabled: { ko: "비활성", en: "Disabled" },
  // IotConnectionStatus (IOTC)
  connected: { ko: "연결됨", en: "Connected" },
  disconnected: { ko: "연결 끊김", en: "Disconnected" },
  // 레거시 한글 키 — 이전 데이터 표시 호환
